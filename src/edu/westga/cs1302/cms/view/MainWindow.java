...
public class MainWindow {
    ...
    void addStudent(ActionEvent event) {
    	...
    	try {
    		...
    		errorPopup.setContentText("Unable to create student: " + errorThing.getMessage() + ". Please reenter grade and try again.");
    		...
    		Alert errorPopup = new Alert(Alert.AlertType.ERROR);
    		errorPopup.setContentText("Unable to create student: " + errorObject.getMessage() + ". Please reenter name and try again.");
    		errorPopup.showAndWait();
    	}
    }
